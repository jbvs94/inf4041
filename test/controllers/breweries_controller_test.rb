...
class BreweriesControllerTest < ActionController::TestCase
  ...
  test "should create brewery" do
    assert_difference('Brewery.count') do
      post :create, brewery: { description: @brewery.description, name: @brewery.name, nb_of_beer: @brewery.nb_of_beer }
    end
  ...
  test "should update brewery" do
    patch :update, id: @brewery, brewery: { description: @brewery.description, name: @brewery.name, nb_of_beer: @brewery.nb_of_beer }
    assert_redirected_to brewery_path(assigns(:brewery))
  end
